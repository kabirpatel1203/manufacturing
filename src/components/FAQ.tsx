...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Minor tweaks are included. Major additions (new dashboards, features) are quoted separately."
    },
    {
      question: "Can I see a demo first?",
      answer: "Yes! Book a free 15-minute call and we'll show you examples."
    }
  ];
