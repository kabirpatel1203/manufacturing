...
const PDF_URL =
  'https://drive.google.com/file/d/1I_szpzZp9bjIwJT6SKT-fXu1vl8w__m5/view?usp=sharing';
...
const Services = () => {
  ...
  const services = [
    {
      ...
      title: 'Inventory Intelligence That Prevents Stockouts',
      description:
        'Get daily reorder alerts by SKU with recommended buy quantities based on your sales velocity and lead times. Stop losing sales to stockouts and free up cash from slow movers.',
      color: 'blue'
    },
    {
      icon: Zap,
      title: 'Profit Protection Dashboard',
      description:
        'See which customers and products actually drive margin vs. just revenue. Get early warnings on slipping accounts, discount drag, and concentration risk—so you can focus on moves that move the numbers.',
      color: 'purple'
    },
    {
      icon: MessageSquare,
      title: 'Ask Your Data Anything',
      description:
        'Query your database in plain English and get instant answers. Like having a data analyst on speed dial.',
      color: 'green'
    }
  ];
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case 'blue':
        return { bg: 'bg-blue-50', icon: 'text-blue-600', button: 'bg-blue-600 hover:bg-blue-700' };
      case 'purple':
        return { bg: 'bg-purple-50', icon: 'text-purple-600', button: 'bg-purple-600 hover:bg-purple-700' };
      case 'green':
        return { bg: 'bg-green-50', icon: 'text-green-600', button: 'bg-green-600 hover:bg-green-700' };
      default:
    ...
    <section className="relative py-16 overflow-hidden bg-white" id="services">
      <div className="container-section relative z-10">
        <motion.div
          ...
          className="max-w-3xl mx-auto text-center mb-12"
        >
          <motion.h2 variants={itemVariants} className="heading-lg text-convrt-dark-blue mb-6">
            Three Ways I Transform Your Business
          </motion.h2>
            ...
            return (
              ...
              >
                <div className="relative z-10">
                  ...
                  <h3 className="heading-sm text-convrt-dark-blue mb-4">{service.title}</h3>

                  <p className="text-convrt-dark-blue/70 mb-6 leading-relaxed">{service.description}</p>

                  {/* All Learn More buttons link to the SAME PDF */}
                  <motion.a
                    href={PDF_URL}
                    target="_blank"
