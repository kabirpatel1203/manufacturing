  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Body */}
        <div className="p-4 space-y-4 bg-slate-200">
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
            {kpis.map((kpi) => (
              <div
                key={kpi.label}
                className="rounded-xl border border-slate-300 bg-slate-100 p-3"
              >
            ...
            <div className="rounded-xl border border-slate-300 bg-slate-100 p-4">
              ...
              <div className="space-y-2">
                {reorderItems.map((item) => (
                  <div
                    key={item.sku}
                    className="flex items-center justify-between rounded-lg border border-slate-300 bg-slate-200 px-3 py-2.5"
                  >
